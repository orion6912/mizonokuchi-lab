 ...
 */
@Configuration
@ComponentScan(value="com.example.demo.dbflute.exbhv")
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.example.demo.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.example.demo.dbflute.allcommon.ImplementedInvokerAssistant();
    }
