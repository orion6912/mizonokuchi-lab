package com.test.dbflute.allcommon;
 ...
 */
@Configuration
@ComponentScan(value="com.test.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.test.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.test.dbflute.allcommon.ImplementedInvokerAssistant();
    }
