package com.test.dbflute.bsentity.dbmeta;
...
public class TUsersDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.test.dbflute.exentity.TUsers"; }
    public String getConditionBeanTypeName() { return "com.test.dbflute.cbean.TUsersCB"; }
    public String getBehaviorTypeName() { return "com.test.dbflute.exbhv.TUsersBhv"; }
